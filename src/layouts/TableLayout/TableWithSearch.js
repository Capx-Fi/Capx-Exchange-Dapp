...
const TableWithSearch = ({
  ...
  return (
    <div className="bg-dark-400 rounded-t-lg pr-40  ml-16 ">
      ...
      <div className="p-4 pt-1 ">
        {rows.length > 0 ? (
          <>
            <table
              {...getTableProps()}
              className="table-auto w-full border border-separate border-dark-50 border-b-0  text-left text-sm rounded-t-xl"
              // style={{
              //   border: "1px solid #2A383C",
              //   borderRadius: "16px!important",
              // }}
            >
              <thead className="text-grayLabel text-xs text-left w-full bg-dark-300 rounded-t-lg">
                {headerGroups.map((headerGroup) => (
                  <tr {...headerGroup.getHeaderGroupProps()}>
                    {headerGroup.headers.map((column) => (
                      <th className="p-4 pt-5 text-left border border-dark-50 border-l-0 border-r-0 border-t-0 border-b-1">
                        <div
